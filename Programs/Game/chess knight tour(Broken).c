    ...
    while(count != beforeCount + 16)
    {
        ...
        else if(quadrant == 4)
        {
            if((row == 5)&&(col == 5)) //LHDS N9
                ...
                if(displayGird[LHDS10R][LHDS10C] == 0)
                    pattern = 3;
                else if(displayGird[LHDS11R][LHDS11C] == 0)
                    pattern = 4;
        ...
        printf("before: %d and %d and %d and %d and %d", row,col,count,pattern,quadrant);
        doMove(pattern);
        printf("after: %d and %d and %d and %d and %d", row,col,count,pattern,quadrant);
        getch();
    }
}
